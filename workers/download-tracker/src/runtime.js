...
function openapiSpec() {
  return {
    ...
    info: {
      ...
      version: VERSION,
      description: "Read-only zero-retention outcome mirror. OS-hooks into AZ-OS under ethics policy. " + MOTTO + " Suite mesh /v1/mesh/* PROXY to aziel-runtime (AZIEL_RUNTIME). Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 packet transfer cross-map. No Node Gate. No public qnsd proxy. No auto-heal. Not anonymity. Aziel Eliab only.",
    },
    servers: [{ url: HOST }],
    paths: {
...
<title>ShadowLock — use with AI assistants</title>
<style>
...
<body>
  <h1>Use with AI assistants</h1>
  <p class="motto">${MOTTO}</p>
  <p>Zero-retention: observe payloads are not stored. Download counters stay on existing KV keys only. Author: <strong>Aziel Eliab</strong> only.</p>
  ...
  <p>Paste this OpenAPI URL into GPT Actions, Grok custom tools, Venice HTTP tools, Claude connectors, Copilot/Bing plugins, Gemini/Vertex, Mistral, Meta AI, Apple Intelligence, Amazon Q, DuckAssist, You.com, Cohere, Perplexity, or any other OpenAPI-capable assistant:</p>
  ...
  <p>Suite mesh: <code>GET ${HOST}/v1/mesh</code> PROXY to aziel-runtime. Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 packet transfer cross-map. No Node Gate. No public qnsd proxy. No auto-heal. Not anonymity. Author: Aziel Eliab only.</p>
