...
const GITHUB_RELEASES = "https://github.com/AzielEliab/shadowlock/releases";
...
async function githubStats(env) {
  ...
  const headers = { "User-Agent": "Mozilla/5.0 ShadowLock-download-tracker", Accept: "application/vnd.github+json" };
  let stars = 0;
  let forks = 0;
  let watchers = 0;
  let release_download_count = 0;
  try {
    const repoRes = await fetch("https://api.github.com/repos/AzielEliab/shadowlock", { headers });
    if (repoRes.ok) {
    ...
    const relRes = await fetch("https://api.github.com/repos/AzielEliab/shadowlock/releases/latest", { headers });
    if (relRes.ok) {
...
# ShadowLock one-click install. Counted download via this Worker.
set -euo pipefail
HOST="${HOST}"
ASSET="${DEFAULT_ASSET}"
...
<title>ShadowLock — Aziel Eliab</title>
<meta name="description" content="Counterfactual observation envelope by Aziel Eliab that compares a finished job to a guess; it does not run jobs or store PII.">
<meta name="author" content="Aziel Eliab">
<link rel="canonical" href="https://shadowlock-download-tracker.vibelock.workers.dev/">
<meta property="og:title" content="ShadowLock — Aziel Eliab">
<meta property="og:description" content="Counterfactual observation envelope by Aziel Eliab that compares a finished job to a guess; it does not run jobs or store PII.">
<meta property="og:url" content="https://shadowlock-download-tracker.vibelock.workers.dev/">
...
<script type="application/ld+json">
{
  ...
  "codeRepository": "https://github.com/AzielEliab/shadowlock",
  "downloadUrl": "https://shadowlock-download-tracker.vibelock.workers.dev/download",
  "license": "https://www.apache.org/licenses/LICENSE-2.0",
  "url": "https://shadowlock-download-tracker.vibelock.workers.dev/",
  "description": "Counterfactual observation envelope by Aziel Eliab that compares a finished job to a guess; it does not run jobs or store PII.",
  "identifier": "https://doi.org/10.5281/zenodo.21435707"
}
</script>
<!-- gitbaby-seo -->
<style>
...
<section class="cite" id="cite">
  <h2>How to cite</h2>
  <p>Aziel Eliab. ShadowLock. https://github.com/AzielEliab/shadowlock. https://shadowlock-download-tracker.vibelock.workers.dev. https://doi.org/10.5281/zenodo.21435707.</p>
  <p><a href="https://aziel-runtime.vibelock.workers.dev/">Catalog</a> · <a href="https://github.com/AzielEliab/shadowlock">GitHub</a> · <a href="https://shadowlock-download-tracker.vibelock.workers.dev/download">Download</a> · <a href="https://shadowlock-download-tracker.vibelock.workers.dev/cite.json">cite.json</a></p>
</section>
<!-- /gitbaby-seo -->
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === "/cite.json" || url.pathname === "/cite.json/") && request.method === "GET") {
      return json({"author": "Aziel Eliab", "title": "ShadowLock", "github": "https://github.com/AzielEliab/shadowlock", "download": "https://shadowlock-download-tracker.vibelock.workers.dev/download", "doi": "10.5281/zenodo.21435707", "license": "Apache-2.0", "catalog": "https://aziel-runtime.vibelock.workers.dev/"});
    }
    // /gitbaby-seo-routes
